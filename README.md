...
``` typescript
import * as pkg from 'https://unpkg.com/@bevry/hooks@^4.3.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/@bevry/hooks@^4.3.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/@bevry/hooks@^4.3.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/@bevry/hooks@4.3.0'
</script>
```
