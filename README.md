...
``` typescript
import * as pkg from 'https://unpkg.com/@bevry/hooks@^4.4.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/@bevry/hooks@^4.4.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/@bevry/hooks@^4.4.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/@bevry/hooks@4.4.0'
</script>
```
...
<ul><li><a href="https://balupton.com">Benjamin Lupton</a> — <a href="https://github.com/bevry/hooks/commits?author=balupton" title="View the GitHub contributions of Benjamin Lupton on repository bevry/hooks">view contributions</a></li></ul>
